<?php
	...
	$sql1 = "INSERT INTO arsip_surat(jenis, no_surat, nik, dari_kpd, tanggal_input, perihal, laci, guide, admin) VALUES ('" . $jenis . "', '', '" . $nik . "','" . $dake . "', NOW(), '" . $laci . " " . $guide . "', '" . $laci . "', '" . $guide . "', '" . $_SESSION['user'] . "')";
